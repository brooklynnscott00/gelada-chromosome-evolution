...
vcfs="vcf/cen-sou.quality-filtered.autosomes_only
gvcf/cen-sou.cohort.autosomes_only.g
vcf/nor-cen.quality-filtered.autosomes_only
gvcf/nor-cen.cohort.autosomes_only.g"
