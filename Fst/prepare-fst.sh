...
realSFS \
	fst index angsd-saf/northern/angsd-northern-$chromosome.saf.idx \
	angsd-saf/central/angsd-central-${chromosome}.saf.idx \
	angsd-saf/southern/angsd-southern-${chromosome}.saf.idx \
