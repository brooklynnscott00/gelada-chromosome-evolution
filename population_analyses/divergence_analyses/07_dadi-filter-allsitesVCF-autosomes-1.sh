...
bcftools view -o -Oz gvcf-dadi-combined-1/${dataset}.NOR.CEN.allsites.nogeno.autosomes.vcf.gz -r $regions gvcf-dadi-combined-1/${dataset}.NOR.CEN.allsites.nogeno.vcf.gz
