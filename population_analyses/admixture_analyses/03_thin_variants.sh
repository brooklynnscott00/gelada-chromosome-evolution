...
mkdir -p angsd_thinned

# custon python script that ensures there are at least 10000bps between each snp
python scripts/thin-variants.py angsd_chr/angsd_genolike_${chr}.beagle.gz $prune_dist angsd_thinned/angsd_genolike_${chr}_thinned.beagle.gz
