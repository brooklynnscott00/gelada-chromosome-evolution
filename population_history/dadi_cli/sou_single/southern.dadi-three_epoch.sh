...
#SBATCH --job-name="southern three_epoch"
...
dadi-cli InferDM --fs dadi_results/southern/${dataset}.southern.6.autosomes.noncoding.lowpass.folded.fs \
    ...
    --nomisid \
	--delta-ll 0.005 \
	--bestfit-p0-file dadi_results/southern/dadi.southern.6.autosomes.noncoding.lowpass.three_epoch.demo.params.InferDM.bestfits \
    --lbounds 1e-12 1e-10 1e-12 1e-12 \
    --ubounds 1e-8 1e-6 1e-6 1e-6 \
	--output-prefix dadi_results/southern/${dataset}.southern.6.autosomes.noncoding.lowpass.three_epoch.demo.params \
