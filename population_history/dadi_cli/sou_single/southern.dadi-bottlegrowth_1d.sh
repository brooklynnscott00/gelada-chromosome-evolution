...
#SBATCH --job-name="southern bottlegrowth 1d"
...
dadi-cli InferDM --fs dadi_results/southern/${dataset}.southern.6.autosomes.noncoding.lowpass.folded.fs \
    ...
    --nomisid \
	--delta-ll 0.005 \
	--bestfit-p0-file dadi_results/southern/dadi.southern.6.autosomes.noncoding.lowpass.bottlegrowth_1D.demo.params.InferDM.bestfits \
    --lbounds 1e-12 1e-8 1e-12 \
    --ubounds 1e-7 1e-3 1e-6 \
	--output-prefix dadi_results/southern/${dataset}.southern.6.autosomes.noncoding.lowpass.bottlegrowth_1D.demo.params \
