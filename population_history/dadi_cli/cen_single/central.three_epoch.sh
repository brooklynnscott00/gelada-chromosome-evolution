...
#SBATCH --job-name="central three_epoch"
...
dadi-cli InferDM --fs dadi_results/central/${dataset}.central.autosomes.noncoding.lowpass.folded.fs \
    ...
    --nomisid \
	--p0 -1 -1 -1 -1 \
    --lbounds 1e-5 1e-5 1e-5 1e-5 \
    --ubounds 10 10 10 10 \
	--output-prefix dadi_results/central/${dataset}.central.autosomes.noncoding.lowpass.three_epoch.demo.params \
