...
dadi-cli InferDM --fs dadi_results/cen-sou/${dataset}.cen-sou.6.22.autosomes.noncoding.lowpass.folded.fs \
	--model founder_asym \
	--bestfit-p0-file dadi_results/cen-sou/dadi.cen-sou.6.22.autosomes.noncoding.lowpass.founder_asym.demo.params.InferDM.bestfits \
    --nomisid \
	--delta-ll 0.005 \
    --lbounds 1e-3 1e-3 1e-4 1e-4 1e-3 \
    --ubounds 100 100 0.99 0.99 100 \
	--output-prefix dadi_results/cen-sou/${dataset}.cen-sou.6.22.autosomes.noncoding.lowpass.founder_asym.demo.params \
