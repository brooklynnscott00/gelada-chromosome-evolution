...
dadi-cli InferDM --fs dadi_results/cen-sou/${dataset}.cen-sou.autosomes.noncoding.rm_common_high_het_sites_0.8.20.6.lowpass.folded.fs \
    --model no_mig \
    --nomisid \
	--bestfit-p0-file dadi_results/cen-sou_2/dadi.cen-sou.autosomes.20.6.noncoding.rm_common_high_het_sites_0.8.lowpass.no_mig.demo.params.InferDM.bestfits \
    --delta-ll 0.005 \
    --lbounds 1e-10 1e-7 1e-10 \
    --ubounds 100 100 100 \
    --output-prefix dadi_results/cen-sou_2/${dataset}.cen-sou.autosomes.20.6.noncoding.rm_common_high_het_sites_0.8.lowpass.no_mig.demo.params \
